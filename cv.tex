...
\bio{4 years of experience solving engineering problems. 1+ years of experience writing Go code in production. 3+ years of experience writing JavaScript code. Deft at reverse engineering. Adept at writing testable, modular and simple code.}

\makecvheader

\cvsection{Experience}

\cvexperience{Software Engineer}{Accedo.tv}{Jan 2020 - Present}{New Delhi, DL, India}{Golang, JavaScript, React, WebOS, Tizen, Android, React-Native, Redux, NodeJS}
\begin{itemize}
...
\cvexperience{Full Stack Developer}{Codalien Technologies Pvt. Ltd.}{Feb 2019 -- Dec 2020}{New Delhi, DL, India}{Golang, JavaScript, ReactJS, NodeJS, Express, React Native, Redux, VueJS, MongoDB, GraphQL}
\begin{itemize}
...
%   \item Developed both frontend (web and mobile) applications as well as backend services powered by latest web technologies and frameworks.
  \item Developed a core back-end component in Go that powers \href{https://play.google.com/store/apps/details?id=com.travx.app}{TravX's} dashboard for thousands of customers and agents. Implemented features such as a thin log library, role-based system to control user's access to endpoints, state management feature to save user's onboarding progress.  
  \item Written a microservice in Go to generate PDF vouchers for \href{https://play.google.com/store/apps/details?id=com.travx.app}{TravX}.
...
\cvexperience{Software Engineer}{DataGrokr Analytics Pvt. Ltd.}{Jun 2017 - Dec 2018}{Bengaluru, KA, India}{Python, Angular, AWS, CloudFormation, EC2, S3, Lambda, DynamoDB, Linux}
\begin{itemize}
...
\begin{multicols}{4} % adjust cols as needed
  \cvlistitem{Instruments}{Guitar, Piano}
  \cvlistitem{Music}{Linkin Park, Radiohead, Coldplay, The Strokes}
  \cvlistitem{Game Development}{Golang + Ebiten}
