...
\cvexperience{Software Engineer}{Accedo.tv}{Jan 2020 - Present}{New Delhi, DL, India}{JavaScript, React, WebOS, Tizen, Android, React-Native, Redux, NodeJS}
\begin{itemize}
  ...
  \item Implemented various features such as Parental Lock, Watchlists, Favourites and Kid's Section on Discovery+ app (custom react-based framework for Web hosted TV applications).
  \item Added custom subtitle, and multi-audio switching support in Discovery+ player (based on Shaka and HLS players)
  \item Ported Accedo VDK app to LG WebOS, Samsung Tizen and Android TV. 
\end{itemize}

\cvexperience{Full Stack Developer}{Codalien Technologies Pvt. Ltd.}{Feb 2019 -- Dec 2020}{New Delhi, DL, India}{JavaScript ES6, ReactJS, NodeJS, Express, React Native, Redux, VueJS, MongoDB, GraphQL}
\begin{itemize}
