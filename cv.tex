...
\cvexperience{Software Engineer}{Accedo.tv}{Jan 2021 - Present}{New Delhi, DL, India}{Golang, JavaScript, React, WebOS, Tizen, Android, React-Native, Redux, NodeJS}
\begin{itemize}
...
%   \item Developed both frontend (web and mobile) applications as well as backend services powered by latest web technologies and frameworks.
  ...
  \item Written a module in Go to generate PDF vouchers for \href{https://play.google.com/store/apps/details?id=com.travx.app}{TravX}.
